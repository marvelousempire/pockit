...
(function () {
  ...
  function renderFooterPanel(scope) {
    ...
    const ledHtml = window.PockitLedLaw?.renderLegend?.({ title: "LED law", className: "pockit-led-law pockit-controls-sheet__led-law" })
      || "";
    const ledTip = window.PockitLedLaw?.tipText?.()
